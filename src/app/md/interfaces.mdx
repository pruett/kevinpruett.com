...
Each interface serves a different “consumer” with different constraints.
...
If you want to poke around the code, it’s here:
👉 [https://github.com/pruett/dayta-mcp](https://github.com/pruett/dayta-mcp)
