...
export const metadata = {
    ...
    description: "An introduction to AI foundations",
    keywords: ["AI", "Foundations", "Software Engineering"],
};
...
<CodeBlock code={`var ReadFileDefinition = ToolDefinition{
    Name:        "read_file",
